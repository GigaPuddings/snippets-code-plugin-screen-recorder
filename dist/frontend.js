import { inject as ae, createVNode as T, getCurrentInstance as me, ref as O, computed as m, unref as l, readonly as lo, getCurrentScope as uo, onScopeDispose as co, onMounted as nt, nextTick as Te, watch as we, isRef as po, warn as ho, provide as fo, defineComponent as E, createElementBlock as N, openBlock as S, mergeProps as go, renderSlot as _e, createElementVNode as d, normalizeClass as z, Transition as wt, withCtx as re, withDirectives as le, normalizeStyle as Le, createTextVNode as vo, toDisplayString as $, vShow as Ke, shallowReactive as yo, createBlock as X, createCommentVNode as Q, resolveDynamicComponent as ln, Fragment as Ne, withModifiers as ze, isVNode as $e, render as Ze, onUnmounted as un, renderList as mo, vModelSelect as rt } from "vue";
const yr = (e) => {
  e.registerRoute({
    target: "window",
    path: "/screen-recorder",
    name: "ScreenRecorder",
    component: () => Promise.resolve().then(() => gr)
  });
};
function wo(e, t, n, o) {
...
class Co {
  ...
  constructor(t) {
    Ue.set(this, void 0), _o(this, Ue, t);
  }
  /**
...
class hn {
  ...
  async onDragDropEvent(t) {
    const n = await this.listen(R.DRAG_ENTER, (i) => {
      t({
        ...i,
        payload: {
          type: "enter",
    ...
    }), o = await this.listen(R.DRAG_OVER, (i) => {
      t({
        ...i,
        payload: {
          type: "over",
    ...
    }), s = await this.listen(R.DRAG_DROP, (i) => {
      t({
        ...i,
        payload: {
          type: "drop",
    ...
    }), a = await this.listen(R.DRAG_LEAVE, (i) => {
  ...
  async onFocusChanged(t) {
    const n = await this.listen(R.WINDOW_FOCUS, (s) => {
      t({ ...s, payload: !0 });
    }), o = await this.listen(R.WINDOW_BLUR, (s) => {
      t({ ...s, payload: !1 });
    });
    return () => {
      n(), o();
...
function bt(e, t, n) {
  var o = {
    ...
    setup: function(a) {
      var i = No(), p = ae(Po, To);
      return function() {
        var f = a.size, v = a.strokeWidth, h = a.strokeLinecap, y = a.strokeLinejoin, x = a.theme, C = a.fill, H = a.spin, g = zo(i, {
          size: f,
          strokeWidth: v,
          strokeLinecap: h,
          strokeLinejoin: y,
...
const Lo = bt("close-small", !1, function(e) {
  return T("svg", {
    width: e.size,
    height: e.size,
    viewBox: "0 0 48 48",
...
}), fn = Symbol(), Ve = "el", Do = "is-", ie = (e, t, n, o, s) => {
  let a = `${e}-${t}`;
  return n && (a += `-${n}`), o && (a += `__${o}`), s && (a += `--${s}`), a;
}, gn = Symbol("namespaceContextKey"), Ro = (e) => {
  const t = e || (me() ? ae(gn, O(Ve)) : O(Ve));
  return m(() => l(t) || Ve);
}, Ct = (e, t) => {
  const n = Ro(t);
  return {
    ...
    bem: (g, w, I) => g && w && I ? ie(n.value, e, g, w, I) : "",
    is: (g, ...w) => {
...
* @license MIT
**/
const Wo = Object.prototype.hasOwnProperty, jt = (e, t) => Wo.call(e, t), Ee = (e) => typeof e == "function", ce = (e) => typeof e == "string", vn = (e) => e !== null && typeof e == "object";
var Fo = typeof global == "object" && global && global.Object === Object && global, Ao = typeof self == "object" && self && self.Object === Object && self, kt = Fo || Ao || Function("return this")(), be = kt.Symbol, yn = Object.prototype, jo = yn.hasOwnProperty, Bo = yn.toString, Ie = be ? be.toStringTag : void 0;
function Ho(e) {
  var t = jo.call(e, Ie), n = e[Ie];
  try {
    e[Ie] = void 0;
    var o = !0;
  } catch {
...
var Go = Object.prototype, Uo = Go.toString;
function Vo(e) {
  return Uo.call(e);
}
var qo = "[object Null]", Ko = "[object Undefined]", Bt = be ? be.toStringTag : void 0;
function mn(e) {
  return e == null ? e === void 0 ? Ko : qo : Bt && Bt in Object(e) ? Ho(e) : Vo(e);
}
function Zo(e) {
...
function St(e) {
  return typeof e == "symbol" || Zo(e) && mn(e) == Jo;
}
function Yo(e, t) {
...
var xt = Array.isArray, Ht = be ? be.prototype : void 0, Gt = Ht ? Ht.toString : void 0;
function wn(e) {
  if (typeof e == "string")
    return e;
  if (xt(e))
...
var Xo = "[object AsyncFunction]", Qo = "[object Function]", es = "[object GeneratorFunction]", ts = "[object Proxy]";
function ns(e) {
  if (!_n(e))
    return !1;
  var t = mn(e);
  return t == Qo || t == es || t == Xo || t == ts;
}
var ct = kt["__core-js_shared__"], Ut = function() {
...
var ss = Function.prototype, is = ss.toString;
function as(e) {
  if (e != null) {
    try {
      return is.call(e);
...
var rs = /[\\^$.*+?()[\]{}|]/g, ls = /^\[object .+?Constructor\]$/, us = Function.prototype, cs = Object.prototype, ds = us.toString, ps = cs.hasOwnProperty, hs = RegExp(
  "^" + ds.call(ps).replace(rs, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function fs(e) {
  if (!_n(e) || os(e))
    return !1;
...
function ws(e, t) {
  if (xt(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || St(e) ? !0 : ms.test(e) || !ys.test(e) || t != null && e in Object(t);
}
...
var Cs = "__lodash_hash_undefined__", ks = Object.prototype, Ss = ks.hasOwnProperty;
function xs(e) {
  var t = this.__data__;
  if (De) {
    var n = t[e];
...
function Ns(e, t) {
  var n = this.__data__;
  return this.size += this.has(e) ? 0 : 1, n[e] = De && t === void 0 ? Ts : t, this;
}
function de(e) {
...
de.prototype.clear = _s;
de.prototype.delete = bs;
de.prototype.get = xs;
de.prototype.has = Ms;
de.prototype.set = Ns;
function zs() {
...
var Ps = Array.prototype, Ls = Ps.splice;
function $s(e) {
...
function qs(e) {
  var t = Ot(e, function(o) {
    return n.size === Vs && n.clear(), o;
  }), n = t.cache;
  return t;
}
var Ks = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Zs = /\\(\\)?/g, Js = qs(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Ks, function(n, o, s, a) {
    t.push(s ? a.replace(Zs, "$1") : o || n);
  }), t;
});
function Ys(e) {
  return e == null ? "" : wn(e);
...
function Xs(e, t) {
  return xt(e) ? e : ws(e, t) ? [e] : Js(Ys(e));
}
function Qs(e) {
...
const Cn = (e) => e === void 0, Vt = (e) => typeof e == "boolean", pe = (e) => typeof e == "number", vt = (e) => typeof Element > "u" ? !1 : e instanceof Element, oi = (e) => ce(e) ? !Number.isNaN(Number(e)) : !1;
var qt;
const fe = typeof window < "u", si = (e) => typeof e == "string", ii = () => {
};
...
const xn = fe ? window : void 0;
function On(...e) {
  let t, n, o, s;
  if (si(e[0]) || Array.isArray(e[0]) ? ([n, o, s] = e, t = xn) : [t, n, o, s] = e, !t)
    return ii;
  Array.isArray(n) || (n = [n]), Array.isArray(o) || (o = [o]);
  const a = [], i = () => {
    a.forEach((h) => h()), a.length = 0;
  }, p = (h, y, x, C) => (h.addEventListener(y, x, C), () => h.removeEventListener(y, x, C)), f = we(() => [Sn(t), It(s)], ([h, y]) => {
    i(), h && a.push(...n.flatMap((x) => o.map((C) => p(h, x, C, y))));
...
Kt[Zt] = Kt[Zt] || {};
var Jt = Object.getOwnPropertySymbols, ui = Object.prototype.hasOwnProperty, ci = Object.prototype.propertyIsEnumerable, di = (e, t) => {
  var n = {};
  for (var o in e)
    ui.call(e, o) && t.indexOf(o) < 0 && (n[o] = e[o]);
  if (e != null && Jt)
    for (var o of Jt(e))
...
function pi(e, t, n = {}) {
  const o = n, { window: s = xn } = o, a = di(o, ["window"]);
  let i;
  const p = li(() => s && "ResizeObserver" in s), f = () => {
...
var hi = Object.defineProperty, Xt = Object.getOwnPropertySymbols, fi = Object.prototype.hasOwnProperty, gi = Object.prototype.propertyIsEnumerable, Qt = (e, t, n) => t in e ? hi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, vi = (e, t) => {
  for (var n in t || (t = {}))
...
const en = {
  current: 0
}, tn = O(0), In = 2e3, nn = Symbol("elZIndexContextKey"), Mn = Symbol("zIndexContextKey"), mi = (e) => {
...
const _i = (e) => (t, n) => bi(t, n, l(e)), bi = (e, t, n) => ti(n, e, e).replace(/\{(\w+)\}/g, (o, s) => {
  var a;
  return `${(a = t?.[s]) != null ? a : `{${s}}`}`;
}), Ci = (e) => {
  const t = m(() => l(e).name), n = po(e) ? e : O(e);
  return {
    lang: t,
    locale: n,
    t: _i(e)
  ...
  const t = e || ae(Tn, O());
  return Ci(m(() => t.value || wi));
}, Nn = "__epPropKey", W = (e) => e, Si = (e) => vn(e) && !!e[Nn], zn = (e, t) => {
  if (!vn(e) || Si(e))
    return e;
  const { values: n, required: o, default: s, type: a, validator: i } = e, f = {
    ...
    validator: n || i ? (v) => {
      ...
      if (n && (y = Array.from(n), jt(e, "default") && y.push(s), h || (h = y.includes(v))), i && (h || (h = i(v))), !h && y.length > 0) {
        const x = [...new Set(y)].map((C) => JSON.stringify(C)).join(", ");
        ho(`Invalid prop: validation failed${t ? ` for prop "${t}"` : ""}. Expected one of [${x}], got value ${JSON.stringify(v)}.`);
      }
      return h;
    } : void 0,
    [Nn]: !0
...
}, xe = (e) => ni(Object.entries(e).map(([t, n]) => [
  t,
  zn(n, t)
])), xi = ["", "default", "small", "large"], Oi = zn({
  type: String,
  values: xi,
  required: !1
}), Ii = Symbol("size"), Mi = Symbol("emptyValuesContextKey"), Ti = xe({
  emptyValues: Array,
  valueOnClear: {
...
const $n = (e, t, n = !1) => {
  var o;
  const s = !!me(), a = s ? Pn() : void 0, i = (o = void 0) != null ? o : s ? fo : void 0;
  if (!i)
    return;
  const p = m(() => {
    const f = l(e);
    return a?.value ? Ni(a.value, f) : f;
  });
  return i(fn, p), i(Tn, m(() => p.value.locale)), i(gn, m(() => p.value.namespace)), i(Mn, m(() => p.value.zIndex)), i(Ii, {
    size: m(() => p.value.size || "")
  }), i(Mi, m(() => ({
...
var $i = /* @__PURE__ */ it(Li, [["__file", "icon.vue"]]);
const Qe = En($i);
...
var Ji = /* @__PURE__ */ it(Zi, [["__file", "badge.vue"]]);
const Yi = En(Ji), Xi = xe({
  a11y: {
    type: Boolean,
    default: !0
  },
...
const Fn = ["success", "info", "warning", "error"], P = Vi({
  customClass: "",
  center: !1,
...
}, oa = (e, t) => V.findIndex((o) => o.id === e) > 0 ? 16 : t, sa = E({
  name: "ElMessage"
}), ia = /* @__PURE__ */ E({
  ...sa,
  props: Qi,
  emits: ea,
  setup(e, { expose: t }) {
    const n = e, { Close: o } = Ui, { ns: s, zIndex: a } = Ln("message"), { currentZIndex: i, nextZIndex: p } = a, f = O(), v = O(!1), h = O(0);
    let y;
    const x = m(() => n.type ? n.type === "error" ? "danger" : n.type : "info"), C = m(() => {
      const k = n.type;
      return { [s.bm("icon", k)]: k && et[k] };
    }), H = m(() => n.icon || et[n.type] || ""), g = m(() => na(n.id)), w = m(() => oa(n.id, n.offset) + g.value), I = m(() => h.value + w.value), te = m(() => ({
      top: `${w.value}px`,
      zIndex: i.value
    }));
    function b() {
      n.duration !== 0 && ({ stop: y } = kn(() => {
        K();
      }, n.duration));
    }
    function G() {
    ...
    return nt(() => {
      ...
      onAfterLeave: (ge) => k.$emit("destroy"),
      persisted: ""
    }, {
      default: re(() => [
        le(d("div", {
          ...
          class: z([
            l(s).b(),
            { [l(s).m(k.type)]: k.type },
            l(s).is("center", k.center),
            l(s).is("closable", k.showClose),
            l(s).is("plain", k.plain),
            k.customClass
          ]),
          style: Le(l(te)),
          role: "alert",
          ...
          _e(k.$slots, "default", {}, () => [
            k.dangerouslyUseHTMLString ? (S(), N(Ne, { key: 1 }, [
...
var aa = /* @__PURE__ */ it(ia, [["__file", "message.vue"]]);
let ra = 1;
const An = (e) => {
  ...
  const o = `message_${ra++}`, s = t.onClose, a = document.createElement("div"), i = {
    ...t,
    id: o,
    onClose: () => {
      s?.(), la(h);
  ...
  }, p = T(aa, i, Ee(i.message) || $e(i.message) ? {
...
const da = Dn(Ce, "$message"), jn = [
  ...
  emits: ha,
  setup(e, { expose: t }) {
    const n = e, { ns: o, zIndex: s } = Ln("notification"), { nextZIndex: a, currentZIndex: i } = s, { Close: p } = Gi, f = O(!1);
    let v;
    const h = m(() => {
      const b = n.type;
      return b && et[n.type] ? o.m(b) : "";
    }), y = m(() => n.type && et[n.type] || n.icon), x = m(() => n.position.endsWith("right") ? "right" : "left"), C = m(() => n.position.startsWith("top") ? "top" : "bottom"), H = m(() => {
      var b;
      return {
        [C.value]: `${n.offset}px`,
    ...
    function te({ code: b }) {
      b === qe.delete || b === qe.backspace ? w() : b === qe.esc ? f.value && I() : g();
    }
    return nt(() => {
      g(), a(), f.value = !0;
      ...
      default: re(() => [
        le(d("div", {
          id: b.id,
          class: z([l(o).b(), b.customClass, l(x)]),
          style: Le(l(H)),
          role: "alert",
          onMouseenter: w,
          onMouseleave: g,
          ...
          d("div", {
            ...
            le(d("div", {
              ...
              _e(b.$slots, "default", {}, () => [
                b.dangerouslyUseHTMLString ? (S(), N(Ne, { key: 1 }, [
                  Q(" Caution here, message could've been compromised, never use user's input as message "),
                  d("p", { innerHTML: b.message }, null, 8, ["innerHTML"])
                ], 2112)) : (S(), N("p", { key: 0 }, $(b.message), 1))
              ])
            ], 6), [
              [Ke, b.message]
            ]),
            b.showClose ? (S(), X(l(Qe), {
              key: 0,
...
var va = /* @__PURE__ */ it(ga, [["__file", "notification.vue"]]);
const tt = {
  "top-left": [],
  "top-right": [],
  "bottom-left": [],
...
const ke = function(e = {}, t) {
  ...
  const s = `notification_${ya++}`, a = e.onClose, i = {
    ...e,
    offset: o,
    id: s,
    onClose: () => {
  ...
  const f = document.createElement("div"), v = T(va, i, Ee(i.message) ? i.message : $e(i.message) ? () => i.message : null);
  return v.appContext = Cn(t) ? ke._context : t, v.props.onDestroy = () => {
    Ze(null, f);
...
function ma(e, t, n) {
  ...
  if (!(f < 1))
    for (let v = s; v < f; v++) {
      const { el: h, component: y } = o[v].vm, x = Number.parseInt(h.style[p], 10) - i - mt;
      y.props.offset = x;
    }
}
function wa() {
...
}, pt = "[screen-recorder]", ba = (e) => {
  if (e)
    return JSON.parse(JSON.stringify(e));
}, q = async (e, t) => {
  const n = performance.now(), o = ba(t);
...
}, Ca = () => q("screen_recorder_get_ffmpeg_status"), ye = (e) => q("screen_recorder_set_capture_excluded", { excluded: e }), Me = (e) => q("screen_recorder_set_passthrough_region", { region: e }), ka = () => q("screen_recorder_pick_target_window"), Sa = () => q("screen_recorder_close_window"), xa = (e, t) => q("screen_recorder_start_recording", {
  region: e,
  fps: t.fps,
  quality: t.quality,
  audio: t.format === "mp4"
}), Oa = () => q("screen_recorder_pause_recording"), Ia = (e, t) => q("screen_recorder_resume_recording", {
  region: e,
  fps: t.fps,
  quality: t.quality,
  audio: t.format === "mp4"
}), Ma = () => q("screen_recorder_stop_recording"), Ta = () => q("screen_recorder_cancel_recording"), Na = (e) => q("screen_recorder_export_recording", {
  format: e.format,
  fps: e.fps,
  quality: e.quality,
  savePath: e.savePath
...
function za() {
  const e = O("selecting"), t = O(sn()), n = O(null), o = O(null), s = O(""), a = O(null), i = O(0), p = O(0), f = O(null), v = () => {
  ...
  }, x = async () => (console.info(`${L} refresh ffmpeg status`), n.value = await Ca(), console.info(`${L} ffmpeg status`, n.value), n.value), C = async (G) => {
    s.value = "", o.value = null, console.info(`${L} begin requested`, { region: G, settings: t.value });
    const K = n.value ?? await x();
    if (!K.available)
      throw new Error(K.message || "FFmpeg unavailable");
    await xa(G, t.value), e.value = "recording", i.value = 0, p.value = 0, a.value = Date.now(), y(), console.info(`${L} recording started`, { status: e.value });
  }, H = async () => {
    e.value === "recording" && (console.info(`${L} pause requested`, { elapsedMs: p.value }), v(), i.value = p.value, a.value = null, h(), await Oa(), e.value = "paused", console.info(`${L} recording paused`, { accumulatedMs: i.value }));
  }, g = async (G) => {
    e.value === "paused" && (console.info(`${L} resume requested`, { region: G, settings: t.value }), await Ia(G, t.value), e.value = "recording", a.value = Date.now(), y(), console.info(`${L} recording resumed`));
  }, w = async () => {
    e.value !== "recording" && e.value !== "paused" || (console.info(`${L} stop requested`, { status: e.value, elapsedMs: p.value }), v(), i.value = p.value, a.value = null, h(), await Ma(), e.value = "exporting", console.info(`${L} recording stopped`, { accumulatedMs: i.value }));
  }, I = async () => (console.info(`${L} export requested`, { settings: t.value }), e.value = "exporting", o.value = await Na(t.value), e.value = "completed", console.info(`${L} export completed`, o.value), o.value), te = async () => {
    console.info(`${L} cancel requested`, { status: e.value, elapsedMs: p.value }), h(), await Ta(), e.value = "selecting", a.value = null, i.value = 0, p.value = 0, o.value = null, console.info(`${L} canceled`);
  }, b = () => {
    console.info(`${L} reset session`), e.value = "selecting", a.value = null, i.value = 0, p.value = 0, o.value = null, s.value = "", t.value = sn();
  };
  return un(() => {
    h();
  }), {
...
const Pa = { class: "screen-recorder" }, La = ["onMousedown"], $a = { class: "window-title" }, Ea = { class: "capture-viewport" }, Da = { class: "capture-frame" }, Ra = { class: "control-strip" }, Wa = { class: "control-group control-group--tools" }, Fa = { class: "tool-pill" }, Aa = ["title", "disabled"], ja = { class: "select-field" }, Ba = ["disabled"], Ha = ["disabled"], Ga = ["disabled"], Ua = { value: "high" }, Va = { value: "standard" }, qa = { value: "small" }, Ka = { class: "dimension-group optional-size" }, Za = { class: "dimension" }, Ja = ["value"], Ya = { class: "dimension" }, Xa = ["value"], Qa = { class: "control-group control-group--actions" }, er = { class: "time" }, tr = { class: "button-label" }, nr = { class: "button-label" }, or = {
  key: 1,
  class: "save-status"
}, sr = ["title"], ir = ["disabled"], ar = { class: "record-label" }, rr = {
  key: 0,
  class: "warning"
}, Y = "[screen-recorder]", Ge = 80, lr = 468, ur = 300, an = 420, rn = 260, cr = 38, dr = 60, ht = 8, ft = 1, pr = /* @__PURE__ */ E({
  __name: "index",
  setup(e) {
    const t = pn(), n = O(null), o = O({ width: 0, height: 0 }), s = O(0), a = O(!1);
    ...
    const v = [
      ...
      cancel: K,
      reset: at
    } = za(), k = m(() => h.value === "recording" || h.value === "paused" || h.value === "exporting"), Re = m(() => y.value.audio && y.value.format === "mp4"), ge = m(() => Re.value && h.value === "recording"), Bn = m(() => {
      const c = ge.value && !a.value ? s.value : 0, r = (_, A) => Math.max(0.18, Math.min(1, _ + c * A)).toFixed(3);
      return {
        "--bar-1": r(0.28, 0.64),
        "--bar-2": r(0.42, 0.78),
        "--bar-3": r(0.34, 0.94),
      ...
      if (x.value?.available && !x.value.systemAudioAvailable) {
        const c = x.value.audioDevices?.join("、") || "无";
      ...
      const r = c.getBoundingClientRect(), _ = await t.scaleFactor(), A = await t.innerPosition(), ne = Tt(r.width * _), ee = Tt(r.height * _);
      if (ne < Ge || ee < Ge)
      ...
      const je = {
        ...
        width: ne / _,
        height: ee / _,
        screenX: Math.round(A.x + r.left * _),
        screenY: Math.round(A.y + r.top * _),
        physicalWidth: ne,
        physicalHeight: ee,
        scale: _
      };
      ...
      const _ = Math.min(c.width, r.width), A = Math.min(c.height, r.height), ne = r.x + r.width - _, ee = r.y + r.height - A;
      return {
      ...
      c.button !== 0 || k.value || (await Fe(), await t.startDragging().catch((r) => {
        dt.msg(r?.message || String(r), "error");
      }), Nt());
    }, Zn = async (c) => {
      k.value || (await Fe(), await t.startResizeDragging(c).catch((r) => {
        dt.msg(r?.message || String(r), "error");
      }), Nt());
    }, Jn = () => Oe(async () => {
      console.info(`${Y} handle start`), await Ae(), await ye(!0).catch(() => {
      }), await F(), await w(await We());
    }), Yn = () => Oe(async () => {
      console.info(`${Y} handle pause`), await I();
    }), Xn = () => Oe(async () => {
      console.info(`${Y} handle resume`), await te(await We());
    }), Qn = () => Oe(async () => {
      console.info(`${Y} handle stop/export`), await b(), s.value = 0, await G(), await F(), await ye(!1).catch(() => {
      });
    }), eo = () => {
      Fe(), at(), h.value = "ready", C.value = null, ye(!0).catch(() => {
      }), t.setSize(new Je(lr, ur)), Te(F), Ae();
    }, to = async (c) => {
      const r = await Mo(c.screenX, c.screenY), _ = r?.scaleFactor || await t.scaleFactor(), A = Math.round((ht + ft) * _), ne = A, ee = Math.round((cr + ht + ft) * _), je = Math.round((dr + ht + ft) * _), Et = Math.round(an * _), Dt = Math.round(rn * _), j = {
        x: c.screenX - A,
        y: c.screenY - ee,
        width: Math.max(Et, c.physicalWidth + A + ne),
        ...
        if (!M) return j;
        const D = M.x + M.width, J = M.y + M.height;
        if (j.x >= M.x && j.y >= M.y && j.x + j.width <= D && j.y + j.height <= J) return j;
        const se = Math.min(j.width, M.width), Be = Math.min(j.height, M.height);
        return {
          x: Math.min(Math.max(j.x, M.x), D - se),
          y: Math.min(Math.max(j.y, M.y), J - Be),
          width: se,
          height: Be
        };
      })();
      ...
      const ro = (() => {
        if (!M) return !1;
        const D = Math.max(4, Math.round(4 * _)), J = M.x + M.width, oe = M.y + M.height, se = c.screenX + c.physicalWidth, Be = c.screenY + c.physicalHeight;
        return c.screenX <= M.x + D || c.screenY <= M.y + D || se >= J - D || Be >= oe - D;
      })();
      try {
        const [D, J] = await Promise.all([
          ...
          y: c.screenY - D.screenY,
          width: c.physicalWidth - D.physicalWidth,
          height: c.physicalHeight - D.physicalHeight
        }, se = {
          x: J.x + oe.x,
          y: J.y + oe.y,
        ...
        console.warn(`${Y} snap correction skipped`, D);
      }
      await F();
    }, no = () => Oe(async () => {
      await Fe();
    ...
    return nt(async () => {
      ...
      }), await Te(), await F(), await Ae(), await Te(), await t.emit("screen_recorder_ready"), n.value && (i = new ResizeObserver(() => {
        F();
      }), i.observe(n.value)), p = await t.onMoved(() => {
        F();
      }).catch(() => null), window.addEventListener("resize", F), window.addEventListener("keydown", $t);
    }), we(Re, (c) => {
      c ? Ae() : Pt();
    }), we(h, (c) => {
      c !== "recording" && (s.value = 0);
    }), un(() => {
      i?.disconnect(), p?.(), window.removeEventListener("resize", F), window.removeEventListener("keydown", $t), Me(null).catch(() => {
      }), ye(!1).catch(() => {
      }), Pt();
    }), (c, r) => (S(), N("div", Pa, [
      d(
        "div",
        {
          class: z(["recorder-shell", { recording: l(h) === "recording", paused: l(h) === "paused" }])
        },
        [
          (S(), N(
            Ne,
            ...
            mo(v, (_) => d("span", {
              key: _.className,
              class: z(["resize-zone", _.className]),
              onMousedown: ze((A) => Zn(_.direction), ["prevent"])
            }, null, 42, La)),
            64
            /* STABLE_FRAGMENT */
          )),
          ...
          d("footer", Ra, [
            d("div", Wa, [
              d("div", Fa, [
                ...
                d("button", {
                  class: z(["audio-meter", { active: ge.value && s.value > 0.03, metering: ge.value && !a.value, muted: !ge.value || a.value }]),
                  title: Hn.value,
                  "aria-label": "系统声音录制状态",
              ...
              le(d("select", {
                ...
                d(
                  "option",
                  Ua,
                  $(c.$t("screenRecorder.qualityHigh")),
                  1
                  /* TEXT */
                ),
                d(
                  "option",
                  Va,
                  $(c.$t("screenRecorder.qualityStandard")),
                  1
                  /* TEXT */
                ),
                d(
                  "option",
                  qa,
                  $(c.$t("screenRecorder.qualitySmall")),
                  1
                  /* TEXT */
                )
              ], 8, Ga), [
            ...
            d("div", Qa, [
              l(h) === "recording" || l(h) === "paused" ? (S(), N(
                ...
                [
                  ...
                  d("button", {
                    ...
                    d(
                      "span",
                      tr,
                      $(l(h) === "paused" ? c.$t("screenRecorder.resume") : c.$t("screenRecorder.pause")),
                      1
                      /* TEXT */
                    )
                  ]),
                ...
                "span",
                or,
                $(c.$t("screenRecorder.exporting") || "正在导出..."),
                1
                /* TEXT */
              )) : l(h) === "completed" && l(C) ? (S(), N(
                Ne,
                { key: 2 },
                [
                  d("span", {
                    ...
                    title: l(C).path
                  }, $(l(C).hasAudio ? "已保存·有声" : "已保存·无声"), 9, sr),
                  d("button", {
                    class: "control-button",
                    title: "打开文件",
                    onClick: so
                ...
                key: 3,
                class: "record-button",
                disabled: l(x)?.available === !1 || o.value.width < Ge || o.value.height < Ge,
                onClick: Jn
              }, [
                r[22] || (r[22] = d(
                  "span",
      ...
      l(x) && !l(x).available ? (S(), N(
        "p",
        rr,
        $(l(x).message || c.$t("screenRecorder.ffmpegMissing")),
        1
        /* TEXT */
      )) : Q("v-if", !0)
    ]));
  ...
  for (const [o, s] of t)
    n[o] = s;
  return n;
}, fr = /* @__PURE__ */ hr(pr, [["__scopeId", "data-v-4e875735"]]), gr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: fr
